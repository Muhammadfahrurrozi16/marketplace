...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('back/img/favicon/favicon.ico')}}"/>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{asset('back/vendor/css/core.css')}}" class="template-customizer-core-css"/>
    <link rel="stylesheet" href="{{asset('back/vendor/css/theme-default.css')}}" class="template-customizer-theme-css"/>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Layouts -->
            <li class="menu-item">
              <a href="/admin/dashboard/user" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Kelola Pengguna</div></a>
              <ul class="menu-sub">
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="/admin/dashboard/kategori" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-layout"></i>
                <div data-i18n="Layouts">Kelola kategori</div></a>
